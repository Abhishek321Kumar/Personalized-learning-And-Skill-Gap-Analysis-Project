...
const dataQuestions = [
  { text: "Which of the following is a common method for handling missing data in a dataset?", options: ["Mean/Median Imputation", "Listwise Deletion", "Data Augmentation", "All of the above"], correctAnswer: "All of the above", section: "technical", skill: "NLP & Deep Learning", difficulty: "easy" },
  ...
  { text: "What defines strategic execution in a data role?", options: ["Running queries as fast as possible", "Aligning data initiatives with broader business goals", "Using the most expensive tools", "Avoiding all meetings"], correctAnswer: "Aligning data initiatives with broader business goals", section: "technical", skill: "Machine Learning Architecture", difficulty: "medium" },
  { text: "How should a data scientist approach cross-functional collaboration with the marketing team?", options: ["Ignore their requests", "Build models without understanding their domain", "Translate their business problems into data questions and communicate progress iteratively", "Tell them data science is too complex to explain"], correctAnswer: "Translate their business problems into data questions and communicate progress iteratively", section: "technical", skill: "Social Media Metrics", difficulty: "easy" }
];
...
const productQuestions = [
  { text: "What is the primary purpose of a Product Vision?", options: ["To provide a long-term guiding light for the product's future", "To list all the features to be built this year", "To create a marketing brochure", "To define the exact budget"], correctAnswer: "To provide a long-term guiding light for the product's future", section: "technical", skill: "Product Vision & Strategy", difficulty: "easy" },
  { text: "Which tool is most commonly used for Market Research to understand broad consumer trends?", options: ["Google Trends", "Jira", "Git", "Postman"], correctAnswer: "Google Trends", section: "technical", skill: "Market Research", difficulty: "easy" },
  { text: "When creating a Product Strategy, which of the following is essential?", options: ["Writing the backend code", "Understanding the target market and unique value proposition", "Designing the company logo", "Hiring the sales team"], correctAnswer: "Understanding the target market and unique value proposition", section: "technical", skill: "Product Vision & Strategy", difficulty: "medium" },
  { text: "What is the main goal of conducting competitor analysis during Market Research?", options: ["To copy their exact features", "To identify market gaps and competitive advantages", "To steal their source code", "To hire their employees"], correctAnswer: "To identify market gaps and competitive advantages", section: "technical", skill: "Market Research", difficulty: "medium" },
...
const marketingQuestions = [
  ...
  { text: "How do you calculate Customer Acquisition Cost (CAC)?", options: ["Total Sales / Number of Customers", "Total Marketing and Sales Cost / Number of New Customers Acquired", "Total Revenue / Total Ad Spend", "Lifetime Value - Ad Spend"], correctAnswer: "Total Marketing and Sales Cost / Number of New Customers Acquired", section: "technical", skill: "Predictive LTV/CAC Analytics", difficulty: "medium" },
  { text: "What is the purpose of UTM parameters in a URL?", options: ["To encrypt the website connection", "To track the source, medium, and campaign name of traffic in Google Analytics", "To improve page loading speed", "To dynamically change the page content"], correctAnswer: "To track the source, medium, and campaign name of traffic in Google Analytics", section: "technical", skill: "Predictive LTV/CAC Analytics", difficulty: "easy" },
  { text: "Which element is most critical in direct-response copywriting?", options: ["A clear and compelling Call to Action (CTA)", "Complex vocabulary", "A minimalist design without text", "Using a passive voice"], correctAnswer: "A clear and compelling Call to Action (CTA)", section: "technical", skill: "Content Strategy & Branding", difficulty: "medium" },
  { text: "What is A/B testing in the context of email marketing?", options: ["Sending an email twice to the same person", "Sending two variations of an email to a subset of subscribers to see which performs better before sending to the rest", "Testing if the email server is online", "Using two different email clients"], correctAnswer: "Sending two variations of an email to a subset of subscribers to see which performs better before sending to the rest", section: "technical", skill: "Predictive LTV/CAC Analytics", difficulty: "easy" },
  { text: "When conducting Marketing Mix Modeling, what are you primarily trying to determine?", options: ["Which font to use on a landing page", "The historical impact of various marketing tactics to optimize future spend and predict ROI", "The exact age of your customers", "Which competitor is spending the most"], correctAnswer: "The historical impact of various marketing tactics to optimize future spend and predict ROI", section: "technical", skill: "Budget Tracking", difficulty: "hard" },
  { text: "If your campaign's CPA is rising but your conversion rate is steady, what is likely happening?", options: ["Your Cost Per Click (CPC) or CPM is increasing", "Your website is broken", "You have stopped spending money", "Users are converting more often"], correctAnswer: "Your Cost Per Click (CPC) or CPM is increasing", section: "technical", skill: "Budget Tracking", difficulty: "hard" },
  { text: "What is an effective strategy for aligning the sales and marketing teams?", options: ["Keep them in separate buildings", "Establish shared KPIs (like pipeline generated) and regular feedback loops", "Let marketing dictate all sales scripts", "Only let sales talk to customers"], correctAnswer: "Establish shared KPIs (like pipeline generated) and regular feedback loops", section: "technical", skill: "Social Media Metrics", difficulty: "medium" },
