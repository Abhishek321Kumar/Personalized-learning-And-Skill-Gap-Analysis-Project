...
const dataQuestions = [
  { text: "Which of the following is a common method for handling missing data in a dataset?", options: ["Mean/Median Imputation", "Listwise Deletion", "Data Augmentation", "All of the above"], correctAnswer: "All of the above", section: "technical", skill: "Data Cleaning", difficulty: "easy" },
  { text: "What is the primary purpose of a validation set in machine learning?", options: ["To train the model", "To tune hyperparameters", "To evaluate final performance", "To clean data"], correctAnswer: "To tune hyperparameters", section: "technical", skill: "Machine Learning", difficulty: "medium" },
  { text: "Which algorithm is typically used for classification tasks?", options: ["Linear Regression", "K-Means Clustering", "Random Forest", "Principal Component Analysis"], correctAnswer: "Random Forest", section: "technical", skill: "Machine Learning", difficulty: "easy" },
  { text: "What does the p-value indicate in hypothesis testing?", options: ["Probability of null hypothesis being true", "Probability of rejecting null hypothesis when true", "Probability of observing the data given the null hypothesis is true", "None of the above"], correctAnswer: "Probability of observing the data given the null hypothesis is true", section: "technical", skill: "Statistics", difficulty: "hard" },
  { text: "Which evaluation metric is best for imbalanced classification datasets?", options: ["Accuracy", "F1 Score", "Mean Squared Error", "R-squared"], correctAnswer: "F1 Score", section: "technical", skill: "Statistics", difficulty: "medium" },
  { text: "In SQL, what is the difference between WHERE and HAVING?", options: ["WHERE filters before grouping, HAVING filters after grouping", "HAVING is for joins, WHERE is for selects", "They are identical", "WHERE is only for numeric data"], correctAnswer: "WHERE filters before grouping, HAVING filters after grouping", section: "technical", skill: "SQL", difficulty: "medium" },
  { text: "What is the curse of dimensionality?", options: ["Algorithms get faster with more dimensions", "Data becomes sparse as dimensions increase, degrading model performance", "Visualizing 3D data is difficult", "None of the above"], correctAnswer: "Data becomes sparse as dimensions increase, degrading model performance", section: "technical", skill: "Data Cleaning", difficulty: "hard" },
  { text: "Which chart is most appropriate for visualizing the distribution of a single continuous variable?", options: ["Scatter plot", "Pie chart", "Histogram", "Line graph"], correctAnswer: "Histogram", section: "technical", skill: "Data Visualization", difficulty: "easy" },
  { text: "What SQL clause is used to sort the result-set?", options: ["SORT BY", "ORDER BY", "GROUP BY", "ALIGN BY"], correctAnswer: "ORDER BY", section: "technical", skill: "SQL", difficulty: "easy" },
  { text: "What does a correlation coefficient of -1 indicate?", options: ["No correlation", "A perfect positive correlation", "A perfect negative correlation", "An error in calculation"], correctAnswer: "A perfect negative correlation", section: "technical", skill: "Data Visualization", difficulty: "medium" },
  { text: "Which of the following represents a Left Join in SQL?", options: ["Returns all records from the left table, and matched records from the right table", "Returns all records when there is a match in either left or right table", "Returns records that have matching values in both tables", "Returns all records from the right table"], correctAnswer: "Returns all records from the left table, and matched records from the right table", section: "technical", skill: "SQL", difficulty: "medium" },
  { text: "What is overfitting in machine learning?", options: ["Model performs well on training data but poorly on unseen data", "Model performs poorly on training data", "Model requires too much computing power", "Model under-represents the data variance"], correctAnswer: "Model performs well on training data but poorly on unseen data", section: "technical", skill: "Machine Learning", difficulty: "easy" }
];

const devQuestions = [
  { text: "In React, what hook is used for side effects?", options: ["useEffect", "useState", "useContext", "useReducer"], correctAnswer: "useEffect", section: "technical", skill: "Frontend", difficulty: "easy" },
  { text: "What is the primary benefit of Server-Side Rendering (SSR)?", options: ["Smaller bundle size", "Improved SEO and initial load time", "Easier state management", "Cheaper hosting"], correctAnswer: "Improved SEO and initial load time", section: "technical", skill: "Frontend", difficulty: "medium" },
  { text: "Which HTTP method is typically used to partially update a resource?", options: ["POST", "PUT", "PATCH", "DELETE"], correctAnswer: "PATCH", section: "technical", skill: "Backend", difficulty: "medium" },
  { text: "What is a closure in JavaScript?", options: ["A function bundled with its lexical environment", "A block of code to handle errors", "A method to close a database connection", "A design pattern for UI components"], correctAnswer: "A function bundled with its lexical environment", section: "technical", skill: "Frontend", difficulty: "hard" },
  { text: "What is the purpose of an index in a relational database?", options: ["To define primary keys", "To speed up data retrieval operations", "To encrypt stored data", "To link two tables"], correctAnswer: "To speed up data retrieval operations", section: "technical", skill: "Database", difficulty: "medium" },
  { text: "Which tool is commonly used for containerization?", options: ["Webpack", "Git", "Docker", "Jenkins"], correctAnswer: "Docker", section: "technical", skill: "DevOps", difficulty: "easy" },
  { text: "In Node.js, what is the Event Loop responsible for?", options: ["Rendering HTML", "Handling asynchronous operations", "Compiling TypeScript", "Managing the DOM"], correctAnswer: "Handling asynchronous operations", section: "technical", skill: "Backend", difficulty: "hard" },
  ...
  { text: "What is the main advantage of a microservices architecture over a monolithic one?", options: ["It is always faster", "It allows independent deployment and scaling of services", "It uses less memory", "It requires no networking"], correctAnswer: "It allows independent deployment and scaling of services", section: "technical", skill: "Architecture", difficulty: "medium" },
  { text: "Which of the following is an example of CI/CD?", options: ["Manually uploading FTP files", "Automated testing and deployment on git push", "Writing unit tests", "Using a CDN for images"], correctAnswer: "Automated testing and deployment on git push", section: "technical", skill: "DevOps", difficulty: "easy" },
  { text: "What is the Virtual DOM in React?", options: ["A lightweight copy of the actual DOM", "A CSS framework", "A browser extension for debugging", "A separate hardware component"], correctAnswer: "A lightweight copy of the actual DOM", section: "technical", skill: "Frontend", difficulty: "medium" },
  { text: "What does a reverse proxy do?", options: ["Directs client requests to the appropriate backend server", "Encrypts local databases", "Serves as a frontend client", "Stores caching keys only"], correctAnswer: "Directs client requests to the appropriate backend server", section: "technical", skill: "Architecture", difficulty: "medium" }
];
...
const productQuestions = [
  ...
  { text: "Which metric is best to measure user retention?", options: ["Daily Active Users (DAU)", "Customer Acquisition Cost (CAC)", "Churn Rate", "Net Promoter Score (NPS)"], correctAnswer: "Churn Rate", section: "technical", skill: "Analytics", difficulty: "medium" },
  { text: "What is Agile methodology primarily focused on?", options: ["Comprehensive documentation", "Iterative development and rapid delivery", "Rigid planning", "Sequential design processes"], correctAnswer: "Iterative development and rapid delivery", section: "technical", skill: "Agile", difficulty: "easy" },
  { text: "What is a User Story?", options: ["An informal, natural language description of a feature from the perspective of an end user", "A marketing blog post", "A technical architecture document", "A customer support ticket"], correctAnswer: "An informal, natural language description of a feature from the perspective of an end user", section: "technical", skill: "User Stories", difficulty: "medium" },
  { text: "Which prioritization framework uses 'Must have, Should have, Could have, Won't have'?", options: ["RICE", "MoSCoW", "Kano Model", "Value vs Effort"], correctAnswer: "MoSCoW", section: "technical", skill: "Prioritization", difficulty: "easy" },
  { text: "What is the primary goal of product discovery?", options: ["Writing code", "Finding out what to build and why", "Marketing the product", "Hiring engineers"], correctAnswer: "Finding out what to build and why", section: "technical", skill: "Product Strategy", difficulty: "medium" },
  { text: "In Scrum, who is responsible for maximizing the value of the product?", options: ["Scrum Master", "Development Team", "Product Owner", "Project Manager"], correctAnswer: "Product Owner", section: "technical", skill: "Agile", difficulty: "easy" },
  { text: "What is A/B testing?", options: ["Testing two versions of a product to see which performs better", "Testing software for bugs", "A method for backend load balancing", "Interviewing two customers simultaneously"], correctAnswer: "Testing two versions of a product to see which performs better", section: "technical", skill: "Analytics", difficulty: "easy" },
  { text: "When evaluating a new feature request from a large customer, what is the best approach?", options: ["Build it immediately to keep them happy", "Assess how it aligns with the overall product vision and benefits the broader user base", "Ignore it unless multiple customers ask", "Let engineering decide"], correctAnswer: "Assess how it aligns with the overall product vision and benefits the broader user base", section: "technical", skill: "Prioritization", difficulty: "medium" },
  { text: "Which part of a User Story defines when the story is complete?", options: ["The Title", "Acceptance Criteria", "The Description", "The Story Points"], correctAnswer: "Acceptance Criteria", section: "technical", skill: "User Stories", difficulty: "easy" },
  { text: "What does CAC stand for in product analytics?", options: ["Customer Average Cost", "Customer Acquisition Cost", "Company Annual Capital", "Centralized Analytics Center"], correctAnswer: "Customer Acquisition Cost", section: "technical", skill: "Analytics", difficulty: "easy" },
  { text: "What does NPS measure?", options: ["Network Protocol Security", "Net Promoter Score (customer loyalty)", "New Product Sales", "None of the above"], correctAnswer: "Net Promoter Score (customer loyalty)", section: "technical", skill: "Analytics", difficulty: "easy" },
  { text: "Which of the following best describes the RICE scoring model?", options: ["Reach, Impact, Confidence, Effort", "Reliability, Integrity, Consistency, Efficiency", "Revenue, Investment, Cost, Earnings", "Research, Ideation, Creation, Evaluation"], correctAnswer: "Reach, Impact, Confidence, Effort", section: "technical", skill: "Prioritization", difficulty: "medium" },
  { text: "Who primarily manages the Product Backlog in Agile Scrum?", options: ["Scrum Master", "Product Owner", "Development Team", "Stakeholders"], correctAnswer: "Product Owner", section: "technical", skill: "Agile", difficulty: "easy" }
];

const uxQuestions = [
  { text: "What does 'Affordance' mean in UX design?", options: ["The cost of a design tool", "Properties of an object that indicate how it can be used", "A legal term for design patents", "The color palette of a UI"], correctAnswer: "Properties of an object that indicate how it can be used", section: "technical", skill: "UI/UX", difficulty: "medium" },
  ...
  { text: "What is a heuristic evaluation?", options: ["An automated code review", "A usability inspection method where evaluators examine an interface and judge its compliance with usability principles", "A survey given to end users", "A tool for creating wireframes"], correctAnswer: "A usability inspection method where evaluators examine an interface and judge its compliance with usability principles", section: "technical", skill: "User Research", difficulty: "medium" },
  { text: "What is a wireframe?", options: ["A high-fidelity interactive prototype", "A low-fidelity structural representation of a web page layout", "A network diagram", "A database schema"], correctAnswer: "A low-fidelity structural representation of a web page layout", section: "technical", skill: "Wireframing", difficulty: "easy" },
  { text: "In color theory, what are complementary colors?", options: ["Colors next to each other on the color wheel", "Colors opposite each other on the color wheel", "Different shades of the same color", "Colors with the same saturation"], correctAnswer: "Colors opposite each other on the color wheel", section: "technical", skill: "UI/UX", difficulty: "easy" },
  ...
  { text: "Which tool is considered the industry standard for collaborative UI design and prototyping today?", options: ["Adobe Photoshop", "Microsoft Paint", "Figma", "AutoCAD"], correctAnswer: "Figma", section: "technical", skill: "Prototyping", difficulty: "easy" },
  { text: "What does 'accessibility' (a11y) ensure in digital design?", options: ["The app is free to download", "The app can be used by people with a wide range of abilities and disabilities", "The app works offline", "The app is responsive on mobile devices"], correctAnswer: "The app can be used by people with a wide range of abilities and disabilities", section: "technical", skill: "UI/UX", difficulty: "medium" },
  { text: "What is a user persona?", options: ["A real customer who uses the product", "A fictional character created to represent a user type that might use a site or product", "A login credential", "A customer support agent"], correctAnswer: "A fictional character created to represent a user type that might use a site or product", section: "technical", skill: "User Research", difficulty: "easy" },
  { text: "What is white space in design?", options: ["Empty areas between design elements", "A specific color code (#FFFFFF)", "A blank HTML document", "A cloud storage area"], correctAnswer: "Empty areas between design elements", section: "technical", skill: "Wireframing", difficulty: "easy" },
  { text: "What is the primary difference between a wireframe and a prototype?", options: ["A wireframe is interactive, a prototype is static", "A wireframe is static and low-fidelity, a prototype is interactive", "They are exactly the same thing", "A wireframe is used for code, a prototype is for design"], correctAnswer: "A wireframe is static and low-fidelity, a prototype is interactive", section: "technical", skill: "Prototyping", difficulty: "medium" },
  { text: "Which research method is best for understanding WHY a user behaves in a certain way?", options: ["A/B Testing", "Analytics tracking", "Qualitative User Interviews", "Heatmaps"], correctAnswer: "Qualitative User Interviews", section: "technical", skill: "User Research", difficulty: "medium" },
  ...
  { text: "According to Hick's Law, what happens when you increase the number of choices?", options: ["Decision time decreases", "Decision time increases logarithmically", "Users make better choices", "It has no effect on decision time"], correctAnswer: "Decision time increases logarithmically", section: "technical", skill: "UI/UX", difficulty: "hard" }
];
